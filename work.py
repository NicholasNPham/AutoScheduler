"""
Work Schedule Auto-Populator

Automatically generates weekly shift schedules and uploads them to a Notion database.
Runs continuously, checking every 12 hours. On Saturdays, generates 5-day schedules
(Monday through Friday) with 8 AM - 5 PM EST shifts.

This script handles the schedule generation logic. Notion database operations
are handled separately in notion.py
...
Requirements:
    - Python 3.13+
    - datetime (standard library in Python 3.13+)
    - zoneinfo (standard library in Python 3.13+)
